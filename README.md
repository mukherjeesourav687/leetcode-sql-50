...
![Progress](https://img.shields.io/badge/Progress-18%2F50-green)
![Status](https://img.shields.io/badge/Status-Active-brightgreen)

# LeetCode SQL 50 Solutions

My solutions to the LeetCode **SQL 50 Study Plan** — solved consistently, one query at a time.
...
| 18 | 185        | Department Top Three Salaries                | Hard       | [View](./185_department_top_three_salaries.sql)            |
...
Complete all **50 problems** from the LeetCode SQL Study Plan and document every solution here.  
Progress is updated regularly as new problems are solved.

---

## Connect

If you're also on a SQL learning journey, let's connect on LinkedIn 🚀
